...
export default function Details() {
  ...
  const {movieId} = useLocalSearchParams() as RouterProps;
      ...
      <View>
        ...
        <View style={styles.description}>
          <View style={styles.descriptionGroup}>
            ...
            <Ionicons  color="#92929D" size={16} name="calendar-clear-sharp" />
            <Text style={styles.descriptionText}>
              {getYear(movieDetails?.release_date)}
            </Text>
          </View>
          <View style={styles.descriptionGroupDivider}><Text>|</Text></View>
          <View style={styles.descriptionGroup}>
            <Ionicons  color="#92929D" size={16} name="time-outline" />
            <Text
...
const styles = StyleSheet.create({
  ...
  descriptionGroupDivider: {
    borderRightWidth: 1,
    borderRightColor: "#92929D",
    marginRight: 10,
  },
  about: {
    padding: 20,
